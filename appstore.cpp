...
//    this->setWindowIcon(QIcon(":/images/Icon.png"));
    ...
    QPalette palette;
    palette.setBrush(QPalette::Background,QBrush(QPixmap(":/images/store_back.png").scaled(this->size())));
    this->setPalette(palette);

    User = new QPushButton(this);
    User->setIcon(QIcon(":/images/User_logo.png"));
    ...
    Game_btn->setIcon(QIcon(":/images/Game2.png"));
    ...
    Life_btn->setIcon(QIcon(":/images/Life.png"));
    ...
    search_btn->setIcon(QIcon(":/images/search_btn.png"));
    ...
    App_snake->setIcon(QIcon(":/images/App_snake.png"));
...
//    snake_status->hide();
    ...
    App_chess->setIcon(QIcon(":/images/App_chess.png"));
...
//    App_chess->hide();
    ...
    chess_status->setIcon(QIcon(":/images/download.png"));
...
//    chess_status->hide();
    ...
    App_fish->setIcon(QIcon(":/images/App_fish.png"));
...
//    App_fish->hide();
    ...
    fish_status->setIcon(QIcon(":/images/download.png"));
...
//    fish_bar->setValue(0);
    ...
    cal_uninstall->setIcon(QIcon(":/images/uninstall.png"));
    ...
    map_uninstall->setIcon(QIcon(":/images/uninstall.png"));
    ...
    snake_uninstall->setIcon(QIcon(":/images/uninstall.png"));
    ...
    chess_uninstall->setIcon(QIcon(":/images/uninstall.png"));
    ...
    fish_uninstall->setIcon(QIcon(":/images/uninstall.png"));
...
void Appstore::Life_click(){
    ...
    fish_uninstall->hide();
    Downloaded_Apps->hide();
    Game_btn->setIcon(QIcon(":/images/Game.png"));
    Life_btn->setIcon(QIcon(":/images/Life2.png"));
...
void Appstore::Map_status_click2(){
    ...
    map_bar->hide();
    map_status->setIcon(QIcon(":/images/ok.png"));
    map_status->show();
    app_status_arr[1] = 1;
}
...
void Appstore::Chess_status_click2(){
    ...
    chess_bar->hide();
    chess_status->setIcon(QIcon(":/images/ok.png"));
    chess_status->show();
}
...
void Appstore::Fish_status_click2(){
    ...
    fish_bar->hide();
    fish_status->setIcon(QIcon(":/images/ok.png"));
    fish_status->show();
}
